...
time: 5:41 AM
today is 12th june but this is the work that i did on june 11th. due to a hectic and hot day i forgot to journal my work.
...
<img width="1152" height="565" alt="image" src="https://github.com/user-attachments/assets/a775eae5-898c-47fa-9743-143fa197d4c5" />
...
I REALLY REALLY WANT TO DO THAT IF MY BUDGET HAS ANY ROOM. 
...
this is the planetary gear mechanism  info 
...
to figure this out we will need to perform transmission matrix 

because the 2dof wrist uses intermeshing 
...
<img width="1163" height="626" alt="image" src="https://github.com/user-attachments/assets/2ff17c70-9375-4d8a-91f9-7193cb6608fe" />
...
2) joint type - revolute
3) parent - link_5
4) child - link_6 ( basically the end effector)
5) mechanism - 2 Dof differential wrist
6) motors - m1+ m2
7) m1 belt - 20teeth to 60 teeth pulley
8) m2 belt - same as above
9) belt stages 1 per motor
10) belt type - open
11) belt reduction 3:1 each
12) helical gear - gear 1 , gear 2 and gear 3
13) helical gear teeth - 25t each
14) helical gear ratio - 1:1
15) motion - rotation about the horizontal wrist axis
16) motor movement - m1+m2 move together
17) origin - established using custom homing routine
18) range - 0 to 180 degree
19) ros joint limit 0 to pi radians

see my wrist has two independent DOFs generated by 2 motors 
for j6 the motors move together to produce horizontal axis wrist movement 

so we do not treat j6 as simply - 
j6+ m2/3 
because m1 and m2 both participatein the differential 
...
1) type - end effector
2) attached to - 2 dof wrist output
3) wrist to gripper reference - 156.844 mm
4) arm dof count - 6DOF
5) actuator - mg996R v17
6) servo calibration - not required
7) control - open / close
8) servo gear - 25 teeth
9) claw 1 gear - 50 teeth
10) claw 2 gear - 50 teeth
11) gear stages - 1
...
<img width="375" height="269" alt="image" src="https://github.com/user-attachments/assets/5d718c7d-6947-4dea-9942-f07c7a69b364" />
...
on amazon for just 4 of these here is the price 
...
its a 100 microfarad capacitor
...
<img width="783" height="470" alt="image" src="https://github.com/user-attachments/assets/27628e8a-5734-4d31-b940-b3701f5c481b" />
...
<img width="409" height="475" alt="image" src="https://github.com/user-attachments/assets/9e75021f-0733-45d5-b274-d2b571bf9a08" />
...
<img width="870" height="583" alt="image" src="https://github.com/user-attachments/assets/7301fad4-47db-4769-b87f-5bc0daba7fdb" />
