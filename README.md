...
* Develop custom electronics and firmware
...
* Generate robotic toolpaths
* Print non-planar geometries
* Experiment with large-format printing techniques
...
* Experiment with construction-scale materials
* Develop modular manufacturing cells
...
* Large-format robotic printing projects
